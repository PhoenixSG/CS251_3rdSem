...
\begin{center}
{
\Large{\textbf{Listing 1: [LaTeX]TeX\\
\large{Algorithm Boilerplate}\label{lst:1}
}
}
}
\end{center}
...
\begin{center}
{
\Large{\textbf{Listing 2: [LaTeX]TeX\\
\large{Packages imported in the original}\label{lst:2}
}
}
}
\end{center}
...
\documentclass{article}
\usepackage[utf8]{inputenc}
\usepackage[a4 paper, hmargin=1.2 in, bottom=1.5in]{geometry}
\usepackage[parfill]{parskip}
\usepackage{hyperref}
\usepackage{fancyhdr}
\usepackage{enumitem}
...
\begin{center}
{
\Large{\textbf{Listing 3: Bash}}\\
\large{\textbf{typeset.sh}
\label{lst:3}}
}
\end{center}
